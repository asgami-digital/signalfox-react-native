  ...
  return (
    ...
    >
      ...
      <ActionButton
        ...
        signalFoxId="expo_modal_open_native_modal"
        onPress={() => {
      ...
      <ActionButton
        label="Test click"
        signalFoxId="expo_modal_idle_click"
        variant="ghost"
        onPress={() => {
      ...
      >
        <View style={styles.backdrop}>
          <View style={styles.card}>
            ...
            <ActionButton
              label="Show alert"
              signalFoxId="expo_modal_alert_button"
              variant="secondary"
              onPress={() => {
            ...
            <ActionButton
              label="Close modal"
              signalFoxId="expo_modal_close_native_modal"
              variant="ghost"
              onPress={() => {
